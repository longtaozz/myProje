...
(function($, window, document) {
	...
	var GroupList = $.GroupList = $.Class.extend({
		...
		findElements: function() {
			...
			self.el.liArray = [].slice.call(self.box.querySelectorAll(classSelector('group-list-inner') + ' li .lh30'));
...
// 			self.el.inner.style.height = withoutSearchHeight;
			var barItemHeight = ((self.el.bar.offsetHeight - 40) / self.el.barItems.length-4) + 'px';
