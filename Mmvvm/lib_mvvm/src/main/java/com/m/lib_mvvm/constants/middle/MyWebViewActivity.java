...
import com.m.lib_mvvm.constants.utils.BaseJavaScript;
 ...
 *
 **/
public abstract class MyWebViewActivity extends MyActivity {
    ...
    public void webViewCreat(String lodUrl, WebView viewWeb, Object javaScriptinterface) {
        ...
        if (javaScriptinterface != null)
            ...
            webView.addJavascriptInterface(new BaseJavaScript(this),
                    "android");
