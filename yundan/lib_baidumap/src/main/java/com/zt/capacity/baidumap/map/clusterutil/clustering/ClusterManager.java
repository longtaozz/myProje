...
package com.zt.capacity.baidumap.map.clusterutil.clustering;
...
import com.zt.capacity.baidumap.map.clusterutil.MarkerManager;
import com.zt.capacity.baidumap.map.clusterutil.clustering.algo.Algorithm;
import com.zt.capacity.baidumap.map.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.zt.capacity.baidumap.map.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.zt.capacity.baidumap.map.clusterutil.clustering.view.ClusterRenderer;
import com.zt.capacity.baidumap.map.clusterutil.clustering.view.DefaultClusterRenderer;
...
//        if (LocationActivity.panorama_button_id == 2) {
//            LatLng target = mMap.getMapStatus().target;
//            LocationActivity.displayPanoramic(target);
//        }
//        if(com.zt.capacity.activity.jinan.LocationActivity1.jn_cluster_state==1){
//            //济南地图改变状态
//            //点聚合
//            com.zt.capacity.activity.jinan.LocationActivity1.juheJinan(com.zt.capacity.activity.jinan.LocationActivity1.presents);
//        }
    }
